...
<div id="page">
	...
	<div id="content">
       ...
       <form action="/sign" method="post">
            ...
            <tr>
		    <td bgcolor="#ffffff"><input type="text" name="query_" align="center" title="Enter your search term" value="" maxlength="1000"></td>
            <td bgcolor="#ffffff" align="Middle"> <input type="submit" /></td>
            </tr> 
            </table>
            </div>
